...
// Fourth bonus — grant writing, funding strategy, fellowships, budgeting.
const bonusSection4: PhdSection = {
  id: "s43",
  colorHex: "#22D3EE",
  dim: "rgba(34,211,238,0.10)",
  border: "rgba(34,211,238,0.32)",
  icon: "💰",
  label: "Grant Writing & Funding Strategy (KR Bonus IV)",
  meta: "22 prompts",
  prompts: ((): PhdPrompt[] => {
    const defs: Array<Omit<PhdPrompt, "vars" | "prompt"> & { vars: string[] }> = [
      { num: "311", title: "Funder Landscape Scanner", badge: "intermediate", useCase: "Map every plausible funder for a research idea across government, foundation, industry and international tiers.", vars: ["TOPIC", "STAGE", "GEOGRAPHY", "BUDGET_RANGE"], frameworks: "Funder taxonomy; NIH/NSF/ERC/Wellcome maps; Foundation Directory; Horizon Europe pillars", output: "Ranked funder shortlist with fit score, deadlines, average award, eligibility flags and a 90-day pursuit calendar.", tip: "Score fit on mission alignment first — money follows mission, not the other way round." },
      { num: "312", title: "NIH R01 Specific Aims Architect", badge: "advanced", useCase: "Draft a one-page Specific Aims that survives the 30-second program officer skim test.", vars: ["GAP", "HYPOTHESIS", "AIMS", "IMPACT"], frameworks: "Russell-Morrison Specific Aims template; NIH significance/innovation/approach; Hook-stake-aim arc", output: "One-page Aims with hook paragraph, central hypothesis, three orthogonal aims, expected outcomes and impact closer.", tip: "Aims must be testable independently — if Aim 1 fails, Aim 2 must still stand or reviewers panic." },
      { num: "313", title: "NSF GRFP Personal Statement Coach", badge: "advanced", useCase: "Write a personal statement that braids identity, intellectual merit and broader impacts without cliché.", vars: ["BACKGROUND", "RESEARCH_ARC", "BROADER_IMPACTS", "FIELD"], frameworks: "NSF Intellectual Merit & Broader Impacts; Narrative arc; STAR vignettes; Equity framing", output: "Two-page personal statement with anchored vignettes, IM/BI signposting, and a forward-looking thesis paragraph.", tip: "Open with a specific scene, never an abstract claim — reviewers remember images, not adjectives." },
      { num: "314", title: "ERC Starting Grant Synopsis Strategist", badge: "advanced", useCase: "Compress a 5-year ERC project into a high-risk-high-gain synopsis that excites Panel reviewers.", vars: ["FIELD", "BREAKTHROUGH", "FEASIBILITY", "PI_TRACK"], frameworks: "ERC evaluation criteria; Frontier research framing; Feasibility risk register; Ground-breaking narrative", output: "1500-character synopsis, B1 extended outline skeleton, and reviewer-anticipation FAQ.", tip: "Name the orthodoxy you intend to overturn — ERC funds heretics, not incrementalists." },
      { num: "315", title: "Marie Skłodowska-Curie Proposal Builder", badge: "advanced", useCase: "Draft an MSCA Postdoctoral Fellowship proposal balancing research, training and two-way knowledge transfer.", vars: ["HOST", "PROJECT", "TRAINING_GAPS", "SECONDMENT"], frameworks: "MSCA Excellence/Impact/Implementation; Career Development Plan; Two-way transfer of knowledge", output: "Section-by-section draft with training-through-research narrative, secondment plan and gender dimension paragraph.", tip: "Make the host's added value concrete — naming labs, instruments and methods beats vague prestige." },
      { num: "316", title: "Wellcome Discovery Award Narrative Coach", badge: "advanced", useCase: "Frame a bold, long-horizon biomedical question for the Wellcome Discovery scheme.", vars: ["QUESTION", "APPROACH", "TEAM", "TIMELINE"], frameworks: "Wellcome Discovery criteria; Vision-to-experiment ladder; Open research commitments", output: "Vision statement, research plan outline, team complementarity matrix, and open-science commitments.", tip: "Lead with the question, not the methods — Wellcome funds curiosity, not toolchains." },
      { num: "317", title: "Industry Partnership Co-Funding Strategist", badge: "intermediate", useCase: "Design a co-funded industry-academic project that protects IP, publication and student careers.", vars: ["PARTNER", "PROBLEM", "DELIVERABLES", "IP_TERMS"], frameworks: "CIFRE/KTP models; Bayh-Dole; Background/foreground IP; Publication delay clauses", output: "Partnership memo with workplan, IP split table, publication policy, milestones and exit terms.", tip: "Negotiate publication windows up front — retroactive disputes destroy partnerships." },
      { num: "318", title: "Budget Justification Architect", badge: "intermediate", useCase: "Write a defensible line-item budget justification that survives sponsor and audit scrutiny.", vars: ["SCHEME", "PERSONNEL", "EQUIPMENT", "INDIRECT_RATE"], frameworks: "Uniform Guidance 2 CFR 200; FEC; Direct vs indirect costs; Cost-share rules", output: "Budget table plus narrative justification per line, with cost-share calculations and audit-ready evidence list.", tip: "Justify each cost in terms of an aim — orphaned line items are the first thing reviewers cut." },
      { num: "319", title: "Reviewer-Mind Pre-Mortem Coach", badge: "intermediate", useCase: "Run a pre-mortem from the reviewer's seat to find the three reasons your proposal will be triaged.", vars: ["PROPOSAL", "PANEL", "WEAKNESSES", "TIME_LEFT"], frameworks: "Pre-mortem (Klein); Reviewer personas; Triage heuristics; Counter-argument scaffolding", output: "Risk register with reviewer-voice critiques, severity score, and a 7-day mitigation plan.", tip: "Recruit one reviewer who hates the idea — friendly readers miss the kill shots." },
      { num: "320", title: "Resubmission Response Strategist", badge: "advanced", useCase: "Turn a triaged or unfunded summary statement into a winning resubmission with disciplined responses.", vars: ["CRITIQUES", "SCORES", "CHANGES", "DEADLINE"], frameworks: "Point-by-point response template; NIH resubmission rules; Tone management; Evidence anchoring", output: "Introduction page, point-by-point response table, revised Aims, and a change-log highlighting concessions vs principled pushbacks.", tip: "Concede small to win big — fight only on the points that change the science, not the prose." },
      { num: "321", title: "Lay Summary Translator", badge: "foundational", useCase: "Translate a technical proposal into a lay summary that funders, patients and journalists can quote.", vars: ["PROJECT", "AUDIENCE", "TONE", "WORD_LIMIT"], frameworks: "Plain language guidelines; Hemingway readability; Patient-partner review; Headline-first writing", output: "Lay summary at target word count, headline, and three pull-quotes for press kits.", tip: "Read it aloud to a smart non-specialist — if they pause, rewrite that sentence." },
      { num: "322", title: "Broader Impacts Designer", badge: "intermediate", useCase: "Design Broader Impacts activities that are credible, measurable and not bolt-on.", vars: ["RESEARCH", "AUDIENCE", "PARTNERS", "METRICS"], frameworks: "NSF Broader Impacts; CARE/FAIR; Logic models; Outcome harvesting", output: "Logic model, partner roles table, evaluation plan with metrics, and a 3-year activity timeline.", tip: "Tie every activity to the science — bolt-on outreach reads as filler in 2025+." },
      { num: "323", title: "Data Management & Sharing Plan Architect", badge: "intermediate", useCase: "Write a 2-page DMSP that meets NIH 2023 and Horizon Europe sharing requirements.", vars: ["DATA_TYPES", "VOLUME", "REPOSITORIES", "RESTRICTIONS"], frameworks: "NIH DMSP 2023; FAIR; CARE; GDPR; Domain repositories (GEO, dbGaP, Zenodo)", output: "DMSP with data inventory, metadata standards, repository selection rationale, access tiers and timelines.", tip: "Name the repository and DOI strategy — vague 'will deposit appropriately' clauses get flagged." },
      { num: "324", title: "Equity Diversity & Inclusion Statement Coach", badge: "intermediate", useCase: "Write an authentic EDI statement that funders such as CIHR, UKRI and NIH increasingly require.", vars: ["TEAM", "COMMUNITY", "ACTIONS", "EVIDENCE"], frameworks: "SEA Change; Athena Swan; CIHR SGBA Plus; Anti-deficit framing", output: "EDI statement with situational analysis, concrete actions, accountability metrics and a 2-year review schedule.", tip: "Cite specific past actions and outcomes — aspirational language without evidence backfires." },
      { num: "325", title: "Letter of Support Drafter", badge: "foundational", useCase: "Draft a letter of support that a collaborator can sign with one edit, not ten.", vars: ["COLLABORATOR", "ROLE", "RESOURCES", "COMMITMENT"], frameworks: "Sponsor letter conventions; Role-specific anchoring; Quantified commitments", output: "Signed-letter draft on plain paper plus a one-line email asking the collaborator to confirm or amend specifics.", tip: "Quantify every commitment (hours, samples, instrument days) — vague pledges weaken the file." },
      { num: "326", title: "Biosketch & CV Optimizer", badge: "intermediate", useCase: "Tailor an NIH biosketch or ERC CV to a specific call, foregrounding fit-relevant outputs.", vars: ["SCHEME", "PROFILE", "TOP_PUBS", "CONTRIBUTIONS"], frameworks: "NIH SciENcv; ERC CV format; Contribution narratives; Quality-over-quantity heuristic", output: "Compliant biosketch/CV with personal statement, contributions to science with significance lines, and a fit-narrative paragraph.", tip: "Pick five papers that prove you can do this project — not your five most cited overall." },
      { num: "327", title: "Foundation Cold-Pitch Email Composer", badge: "foundational", useCase: "Write a 200-word inquiry email to a private foundation that earns a meeting, not a polite no.", vars: ["FOUNDATION", "PROGRAM", "ASK", "PROOF"], frameworks: "Cold outreach; Hook-stake-ask; Proof-of-traction; Mission alignment language", output: "Tight email with subject line, two-sentence hook, traction paragraph, and explicit ask for a 20-minute call.", tip: "Reference a specific grant they made last year — generic outreach gets filtered out instantly." },
      { num: "328", title: "Internal Seed Grant Strategist", badge: "foundational", useCase: "Use small internal seed funds to generate the pilot data needed for an external R01/ERC bid.", vars: ["SEED_AMOUNT", "PILOT_AIM", "EXTERNAL_TARGET", "TIMELINE"], frameworks: "Seed-to-external pipelines; Pilot data design; Statistical power for pilots; Bridge funding", output: "Seed proposal plus a 12-month roadmap that names the external scheme and milestones the pilot must hit.", tip: "Design the pilot to answer the reviewer's likeliest objection on the external bid." },
      { num: "329", title: "Multi-PI Leadership Plan Composer", badge: "intermediate", useCase: "Draft a Multi-PI leadership plan that demonstrates true scientific equality and conflict management.", vars: ["PIS", "ROLES", "DECISION_RULES", "DISPUTES"], frameworks: "NIH Multi-PI policy; RACI; Decision logs; Authorship pre-agreements", output: "Leadership plan with role table, decision rules, communication cadence, conflict-resolution path and authorship policy.", tip: "Spell out who owns what data and corresponding-author rights up front — assume disputes, not goodwill." },
      { num: "330", title: "Funder Pivot Translator", badge: "advanced", useCase: "Re-package one proposal for a second funder without violating duplicate-submission rules.", vars: ["ORIGINAL", "NEW_FUNDER", "OVERLAP", "DIFFERENTIATION"], frameworks: "Duplicate-submission rules; Differentiation matrix; Aim-level versioning; Overlap statements", output: "Pivot matrix showing aim-level differences, a fresh narrative angle, and a clean overlap statement to attach.", tip: "Change the central question, not just the wrapper — reviewers compare funded portfolios and notice." },
      { num: "331", title: "Costed Workplan & Gantt Designer", badge: "intermediate", useCase: "Build a costed workplan and Gantt that proves feasibility within the proposed budget and team.", vars: ["AIMS", "TASKS", "FTE", "MILESTONES"], frameworks: "Work breakdown structure; Critical path; FTE loading; Risk-adjusted Gantt", output: "Workplan table, FTE loading per task, Gantt with milestones and decision gates, and a slack-buffer commentary.", tip: "Show 10–15% slack — proposals with zero buffer read as fantasy to experienced reviewers." },
      { num: "332", title: "Post-Award Compliance Onboarder", badge: "intermediate", useCase: "Stand up post-award compliance: reporting calendar, financial controls, regulatory triggers and audits.", vars: ["AWARD", "REPORTS", "COMPLIANCE", "AUDIT_RISK"], frameworks: "Uniform Guidance; RPPR; FCOI; IRB/IACUC continuing review; Subaward monitoring", output: "Compliance binder with reporting calendar, internal controls, escalation matrix and an audit-readiness checklist.", tip: "Schedule reports 30 days before they are due — late reports throttle next-cycle eligibility." },
    ];
    return defs.map((d) => ({
      ...d,
      prompt: `You are a ${d.title}. Working with inputs ${d.vars
